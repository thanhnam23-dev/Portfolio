<template>
    <nav
        class="fixed top-0 w-full bg-white/80 dark:bg-brand-dark/80 backdrop-blur-md border-b border-gray-200 dark:border-brand-border z-50 transition-colors duration-300">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="hidden sm:inline text-lg font-bold text-gray-900 dark:text-brand-text-primary">
                        Truong Thanh Nam
                    </span>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <Link :href="route('language.switch', 'vi')" preserve-scroll
                    ...
                    <button @click="toggleDark"
                        class="p-2 rounded-lg bg-gray-100 dark:bg-brand-surface hover:bg-gray-200 dark:hover:bg-brand-border transition-colors">
                    ...
                    <button @click="isOpen = !isOpen"
                        class="md:hidden p-2 text-gray-600 dark:text-brand-text-secondary">
